...
Мештастик нода, основанная на модулях e22-900m30s/e22-900m33s и микроконтроллере promicro nRF52840 с внешним питанием 5 вольт (максимум 5.5v) 1 ампер (1.3А в пике для m33s).
